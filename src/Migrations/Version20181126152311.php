 ...
 */
final class Version20181126152311 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, id_produit_id INT DEFAULT NULL, iduser_id INT DEFAULT NULL, INDEX IDX_24CC0DF2AABEFE2C (id_produit_id), INDEX IDX_24CC0DF2786A81FB (iduser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
