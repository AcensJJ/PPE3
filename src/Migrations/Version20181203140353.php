 ...
 */
final class Version20181203140353 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commande_order (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, reference VARCHAR(255) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_CC414C5BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE identity_order (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, num_tel INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, code_postal INT NOT NULL, ville VARCHAR(255) NOT NULL, pays VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE livraison_order (id INT AUTO_INCREMENT NOT NULL, date_livraison DATETIME DEFAULT NULL, date_envoie DATETIME DEFAULT NULL, adresse VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mode_livraison (id INT AUTO_INCREMENT NOT NULL, livraison_id INT DEFAULT NULL, mode VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_C1D2B2A78E54FB25 (livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE mode_livraison ADD CONSTRAINT FK_C1D2B2A78E54FB25 FOREIGN KEY (livraison_id) REFERENCES livraison_order (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mode_livraison DROP FOREIGN KEY FK_C1D2B2A78E54FB25');
